...
export default async function Home() {
  ...
  const highlights = [
    "Rilis statistik resmi untuk mendukung keputusan daerah.",
    "Filter P421, P424, P425, dan P426 terhubung langsung ke diagram.",
  ]
        ...
        <section className="min-w-0 flex-1 px-3 py-4 md:px-5">
          <div className="rounded-2xl border border-orange-200/80 bg-orange-50/65 p-4 md:p-5">
            <section className="relative mb-6 overflow-hidden rounded-2xl border border-orange-200/90">
              ...
              <div className="absolute inset-0 p-5 md:p-7">
                <h1 className="mt-3 max-w-2xl font-[family-name:var(--font-heading)] text-xl font-black text-white md:text-3xl">
                  Dashboard Ekonomi Digital Kuansing
                </h1>
                <p className="mt-2 max-w-2xl text-sm text-orange-50/95 md:text-base">
                  Platform visualisasi statistik usaha untuk mendukung perencanaan, pemantauan, dan evaluasi kebijakan berbasis data.
                </p>
            ...
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                <h2 className="font-[family-name:var(--font-heading)] text-2xl font-black text-stone-800 md:text-3xl">Statistik Usaha Terfilter</h2>
                <p className="mt-2 text-sm text-orange-900/75 md:text-base">Setiap diagram menyesuaikan pilihan filter P421, P424, P425, dan P426 secara real-time.</p>
              </div>
              <p className="text-sm font-semibold text-orange-700">Sumber: Data lokal usaha</p>
            </div>
