...
export default function P421Filter() {
  const { state, setKeyword, toggleCode, clearCodes } = useCodeFilter("p421")
  ...
  return (
    <section className="rounded-2xl border border-orange-200 bg-orange-50/85 p-4 md:p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="font-[family-name:var(--font-heading)] text-lg font-bold text-orange-900">Lapangan Usaha</h3>
        </div>
        <button
          type="button"
        ...
        <>
          <div className="mt-4 flex gap-2">
            <input
              ...
              placeholder="Cari kategori lapangan usaha..."
