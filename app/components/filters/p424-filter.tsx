...
export default function P424Filter() {
  const { state, setKeyword, toggleCode, clearCodes } = useCodeFilter("p424")
  ...
  return (
    <section className="rounded-2xl border p-4 md:p-5" style={{ borderColor: 'rgba(232, 129, 50, 0.2)', backgroundColor: '#FFFFFF' }}>
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="font-sans text-lg font-bold" style={{ color: '#E88132' }}>Perizinan Usaha</h3>
        </div>
        <button
          type="button"
        ...
        <>
          <div className="mt-4 flex gap-2">
            <input
              ...
              placeholder="Cari status perizinan usaha..."
